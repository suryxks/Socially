...
import { Explore, Login, SignUp, Home, Profile, BookMarks, SinglePostPage } from '../pages';
...
export const AppRoutes = () => {
    return (<Routes>
        ...
        <Route path='/profile/:username' element={<PrivatRoutes><Profile /></PrivatRoutes>} />
        <Route path='/bookmarks' element={<PrivatRoutes><BookMarks /></PrivatRoutes>} />
        <Route path='/posts/:postId' element={<PrivatRoutes><SinglePostPage /></PrivatRoutes>} />
    </Routes>)
}
